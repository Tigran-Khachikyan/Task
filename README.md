...
This kind of requests must be done on the **Main thread**. An instance of anonymous class from **AsyncResultListener<R>** interface should be used for obtaining the response, where R is the type of Response associated with the kind of method (*PaymentResponseData* in the examples).<br/>
Java version<br/>
