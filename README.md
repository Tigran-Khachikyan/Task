...
This kind of requests must be done on the **Main thread**. An instance of anonymous class from AsyncResultListener<T> interface should be used for obtaining the response, where T is the type of Response associated with the kind of method (*PaymentResponseData* in the examples).<br/>
Java version<br/>
